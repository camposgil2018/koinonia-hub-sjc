...
import { Home, CalendarDays, Users, Megaphone, Menu, ChevronDown, UserCog, LogOut } from "lucide-react";
    ...
    <div className="p-3 border-t border-sidebar-border">
      <div className="flex items-center gap-3 rounded-lg px-2 py-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-[11px] text-sidebar-foreground/60">{u.role === "admin" ? "Administrador" : "Membro"}</div>
        </div>
        <button
          onClick={() => { auth.logout(); toast.success("Sessão encerrada"); }}
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuItem onClick={() => { auth.logout(); toast.success("Sessão encerrada"); }}>
